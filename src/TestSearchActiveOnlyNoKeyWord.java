...
public class TestSearchActiveOnlyNoKeyWord {
  ...
  @Test
  public void testSearchActiveOnlyNoKeyWord() throws Exception {
    driver.get("http://localhost:7000/");
    Thread.sleep(500);

    driver.findElement(By.xpath("//button[@onclick='viewActiveOnly()']")).click();
    Thread.sleep(500);
