...
public class TestCreateListingValid {
  ...
  @Test
  public void testCreateListingValid() throws Exception {
    ...
    String lstTitle = driver.findElement(By.id("lst-title")).getText();
    System.err.println(lstTitle);
    if (!lstTitle.contains("TITLE_VALID")) {
    	fail("Invalid Title");
    }
  }
