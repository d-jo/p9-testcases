...
public class TestSearchListingValidKeyWord {
  ...
  @Test
  public void testSearchListingValidKeyWord() throws Exception {
    driver.get("http://localhost:7000/");
    Thread.sleep(500);

    driver.findElement(By.id("search")).click();
    driver.findElement(By.id("search")).clear();
    driver.findElement(By.id("search")).sendKeys("Algorithm");
    Thread.sleep(500);

    driver.findElement(By.xpath("//button[@onclick='search()']")).click();
    Thread.sleep(500);
