...
public class TestUpdateAListingWithInvalidPassword {
  ...
  @Test
  public void testUpdateAListingWithInvalidPassword() throws Exception {
    ...
    driver.findElement(By.id("title")).click();
    driver.findElement(By.id("title")).clear();
    driver.findElement(By.id("title")).sendKeys("Operating Systems Invalid");
    driver.findElement(By.id("listing_password")).click();
    driver.findElement(By.id("listing_password")).clear();
    driver.findElement(By.id("listing_password")).sendKeys("invalidpassword");
